...
export default function ServiceHourForm() {
  ...
  return (
    <>
      <section className="w-70 sm:w-140 md:w-165 lg:w-235 p-4 rounded-lg gap-4 flex flex-col lg:flex-row items-center justify-center">
      ...
      {loading && (
        <section className="bg-white/50 backdrop-blur-sm flex items-center justify-center fixed inset-0">
          <div className="text-gray-700 rounded-lg text-2xl p-4 flex flex-col items-center justify-center gap-4">
